...
class LibrarySimulation:
    def __init__(self, max_time=30, ave_clients_distribution=3, ave_student_distribution=3,
    ...
    def client_arrive(self):
        ...
        while time.time() - self.start_time < self.max_time:
            ...
            with self.lock:
                ...
                self.interface.print(self.clients_waiting)
                print(f'Cola: {self.clients_waiting}')
